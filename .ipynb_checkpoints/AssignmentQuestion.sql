...
--A.How many days on average are customers reallocated to a different node?
SELECT
...
--A.5 Median, 80th and 95th percentile reallocation days for each region
WITH realloc AS (
    SELECT
        r.region_name,
...
--B.3. For each month, how many customers make More than 1 deposit and either 1 purchase OR 1 withdrawal in the same month
